...
export const productPricing: Record<string, ProductPricing> = {
  "dark-cacao-sea-salt": { options:[
    option("box-6","Box of 6 pieces","6 துண்டு பெட்டி",590,"Recommended core launch format","பரிந்துரைக்கப்பட்ட முக்கிய அறிமுக அளவு"),
    option("box-9","Box of 9 pieces","9 துண்டு பெட்டி",860,"Recommended sharing and gifting format","பகிர்வு மற்றும் பரிசளிப்பு அளவு"),
  ]},
  "ragi-no-01": { options:[
    option("box-6","Box of 6 pieces","6 துண்டு பெட்டி",590,"Current launch formulation uses egg","தற்போதைய அறிமுக வகையில் முட்டை பயன்படுத்தப்படுகிறது"),
    option("box-9","Box of 9 pieces","9 துண்டு பெட்டி",860,"Recommended sharing and gifting format","பகிர்வு மற்றும் பரிசளிப்பு அளவு"),
  ]},
  "walnut-reserve": { options:[
    option("box-6","Box of 6 pieces","6 துண்டு பெட்டி",620,"Includes toasted-walnut ingredient premium","வறுத்த வால்நட் பொருள் விலை சேர்க்கப்பட்டுள்ளது"),
    option("box-9","Box of 9 pieces","9 துண்டு பெட்டி",890,"Recommended gifting format","பரிந்துரைக்கப்பட்ட பரிசு அளவு"),
  ]},
  ...
  "biscoff-crunch": { options:[
    option("box-6","Box of 6 pieces","6 துண்டு பெட்டி",620,"Release after ingredient and allergen verification","பொருள் மற்றும் அலர்ஜன் சோதனைக்குப் பிறகு"),
    option("box-9","Box of 9 pieces","9 துண்டு பெட்டி",905,"V5 selling price","V5 விற்பனை விலை"),
  ]},
  ...
  "strawberry-cacao": { options:[
    option("box-6","Seasonal box of 6","பருவகால 6 துண்டு பெட்டி",650,"Fresh-fruit and delivery test required","புதிய பழம் மற்றும் டெலிவரி சோதனை தேவை"),
    option("box-9","Seasonal box of 9","பருவகால 9 துண்டு பெட்டி",950,"Limited verified dates only","சோதிக்கப்பட்ட குறிப்பிட்ட தேதிகளில் மட்டும்"),
  ]},
  "signature-discovery-box": { options:[
    option("house-six","House Six · one of each listed flavour","ஹவுஸ் சிக்ஸ் · பட்டியலிட்ட ஒவ்வொரு சுவையிலும் ஒன்று",590,"Dark Cacao, Walnut, Pista, Strawberry, Biscoff and Wafer when all are validated","அனைத்தும் சோதிக்கப்பட்டால் டார்க் காகாவ், வால்நட், பிஸ்தா, ஸ்ட்ராபெரி, பிஸ்காஃப் மற்றும் வேஃபர்"),
    option("ragi-walnut-3-3","3 Ragi + 3 Walnut Reserve","3 ராகி + 3 வால்நட் ரிசர்வ்",620,"Recommended two-flavour mix; one formulation per box","பரிந்துரைக்கப்பட்ட இரண்டு சுவை கலவை; ஒரு பெட்டிக்கு ஒரே வகை"),
    option("choose-two-3-3","Choose 2 validated flavours · 3+3","சோதிக்கப்பட்ட 2 சுவைகள் · 3+3",620,"Premium and seasonal flavours may be subject to availability","பிரீமியம் மற்றும் பருவகால சுவைகள் கிடைப்பதற்கு உட்பட்டவை"),
  ]},
  "reserve-collection": { options:[
    ...
    option("ragi-walnut-pista-3-3-3","3 Ragi + 3 Walnut + 3 Pista","3 ராகி + 3 வால்நட் + 3 பிஸ்தா",860,"Recommended three-flavour mix; one formulation per box","பரிந்துரைக்கப்பட்ட மூன்று சுவை கலவை; ஒரு பெட்டிக்கு ஒரே வகை"),
  ...
  "brownie-tin-3-piece": { options:[
    ...
    option("one-flavour-premium","1 premium flavour · 3 pieces","1 பிரீமியம் சுவை · 3 துண்டுகள்",360,"Walnut, Pista or a validated seasonal/confectionery flavour","வால்நட், பிஸ்தா அல்லது சோதிக்கப்பட்ட பருவகால/கான்ஃபெக்ஷனரி சுவை"),
  ]},
  ...
  "classic-brownie-tub": { options:[
    option("single-tub","1 regular tub · target 250 g","1 சாதாரண டப் · இலக்கு 250 கிராம்",270,"V5 selling price","V5 விற்பனை விலை"),
    option("tub-duo","Duo · 2 regular tubs","2 சாதாரண டப்கள்",490,"V5 duo price","V5 டூயோ விலை"),
  ]},
  "loaded-brownie-tub": { options:[
    option("single-tub","1 loaded tub · target 250 g","1 லோடெட் டப் · இலக்கு 250 கிராம்",270,"V5 selling price; topping confirmation applies","V5 விற்பனை விலை; டாப்பிங் உறுதிப்படுத்தல் பொருந்தும்"),
    option("tub-duo","Duo · 2 loaded tubs","2 லோடெட் டப்கள்",490,"Topping cost and transport test required","டாப்பிங் செலவு மற்றும் போக்குவரத்து சோதனை தேவை"),
  ]},
  "ragi-cacao-tea-cake": { options:[
    option("loaf-450","1 loaf · target 450 g","1 லோஃப் · இலக்கு 450 கிராம்",420,"Yield and shelf-life confirmation applies","யீல்ட் மற்றும் சேமிப்பு உறுதிப்படுத்தல் பொருந்தும்"),
    option("loaf-duo","Gift duo · 2 × target 450 g","பரிசு டூயோ · 2 × இலக்கு 450 கிராம்",790,"One presentation, one delivery address","ஒரே பேக்கிங் மற்றும் ஒரு டெலிவரி முகவரி"),
  ]},
  "pista-cardamom-tea-cake": { options:[
    option("loaf-450","1 loaf · target 450 g","1 லோஃப் · இலக்கு 450 கிராம்",420,"Pistachio cost and yield confirmation applies","பிஸ்தா செலவு மற்றும் யீல்ட் உறுதிப்படுத்தல் பொருந்தும்"),
    option("loaf-duo","Gift duo · 2 × target 450 g","பரிசு டூயோ · 2 × இலக்கு 450 கிராம்",790,"One presentation, one delivery address","ஒரே பேக்கிங் மற்றும் ஒரு டெலிவரி முகவரி"),
  ]},
  ...
  "mini-brownie-tower": { options:[
    ...
    option("tower-18","Tower of 18 pieces","18 துண்டு டவர்",780,"Delivery route must be confirmed","டெலிவரி பாதை உறுதி செய்யப்பட வேண்டும்"),
  ]},
  ...
  "corporate-mini-box": { options:[
    option("tier-25-ragi-walnut","25–49 boxes · 2 Ragi + 2 Walnut · per box","25–49 பெட்டிகள் · 2 ராகி + 2 வால்நட் · ஒரு பெட்டி",490,"Recommended lead composition; one common message","பரிந்துரைக்கப்பட்ட முக்கிய கலவை; ஒரு பொதுவான செய்தி"),
    ...
    option("tier-50","50–99 boxes · 2 Ragi + 2 Walnut · per box","50–99 பெட்டிகள் · 2 ராகி + 2 வால்நட் · ஒரு பெட்டி",490,"Controlled 2+2 mix and one common message","கட்டுப்படுத்தப்பட்ட 2+2 கலவை மற்றும் ஒரு பொதுவான செய்தி"),
    option("tier-100","100+ boxes · 2 Ragi + 2 Walnut · per box","100+ பெட்டிகள் · 2 ராகி + 2 வால்நட் · ஒரு பெட்டி",490,"Margin floor and home-kitchen capacity confirmation still apply","மார்ஜின் வரம்பும் வீட்டு சமையலறை திறன் உறுதிப்படுத்தலும் பொருந்தும்"),
  ]},
  ...
  "party-single-brownies": { options:[
    option("classic-25","25 Classic brownies · individually packed","25 கிளாசிக் பிரௌனிகள் · தனித்தனி பேக்கிங்",2400,"25-piece launch bundle · up to two flavours","25 துண்டு அறிமுக தொகுப்பு · இரண்டு சுவைகள் வரை"),
  ...
  "party-brownie-tins": { options:[
    ...
    option("larger","25+ Tins · custom proposal","25+ டின்கள் · தனிப்பயன் விலை",7800,"V5 bundle price; final flavour and packaging confirmation applies","V5 தொகுப்பு விலை; இறுதி சுவை மற்றும் பேக்கிங் உறுதி பொருந்தும்"),
  ]},
  "party-brownie-tubs": { options:[
    ...
    option("loaded-10","10 Loaded Brownie Tubs","10 லோடெட் பிரௌனி டப்கள்",2300,"10-Tub bundle · topping confirmation required","10 டப் தொகுப்பு · டாப்பிங் உறுதிப்படுத்தல் தேவை"),
    option("larger","25+ Tubs · custom proposal","25+ டப்கள் · தனிப்பயன் விலை",5500,"V5 bundle price; topping, seal and delivery confirmation applies","V5 தொகுப்பு விலை; டாப்பிங், சீல் மற்றும் டெலிவரி உறுதிப்படுத்தல் பொருந்தும்"),
  ]},
