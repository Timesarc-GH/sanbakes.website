    ...
    <main>
      ...
      <div id="party-collection">
        <ProductCollection
          ...
          introEn="Every product has its own image, selectable quantity or finish, listed price and cart control. Delivery and paid customisation are confirmed separately on WhatsApp."
          introTa="ஒவ்வொரு பொருளுக்கும் தனிப்பட்ட படம், அளவு அல்லது அலங்காரத் தேர்வு, பட்டியலிட்ட விலை மற்றும் கார்ட் வசதி உள்ளது. டெலிவரி மற்றும் கூடுதல் தனிப்பயன் WhatsApp-ல் தனியாக உறுதி செய்யப்படும்."
        />
      </div>
      ...
      <section className="eventRules">
        ...
        <div className="eventTerms"><h3>{en ? "Booking rules" : "முன்பதிவு விதிகள்"}</h3><ul><li>{en ? "A 50% deposit reserves the date; the balance is due three business days before handover." : "50% முன்பணம் தேதியை உறுதி செய்யும்; மீதித் தொகை ஹேண்ட்ஓவருக்கு மூன்று வேலை நாட்களுக்கு முன் செலுத்த வேண்டும்."}</li><li>{en ? "Final quantity, flavours, formulation, message and finish close five calendar days before the event. Choose Regular (with egg) or Eggless for every product before adding it to the cart." : "இறுதி அளவு, சுவைகள், தயாரிப்பு வகை, செய்தி மற்றும் அலங்காரம் நிகழ்ச்சிக்கு ஐந்து நாட்களுக்கு முன் முடிக்கப்பட வேண்டும். ஒவ்வொரு தயாரிப்பையும் கார்ட்டில் சேர்ப்பதற்கு முன் வழக்கமானது (முட்டையுடன்) அல்லது முட்டையில்லா என்பதைத் தேர்ந்தெடுக்கவும்."}</li><li>{en ? "Up to two flavours for 25–49 packed brownies; up to four flavours for 50+ pieces. Tins and Tubs use one or two coordinated finishes per batch." : "25–49 தனித்தனி பிரௌனிகளுக்கு இரண்டு சுவைகள் வரை; 50+ துண்டுகளுக்கு நான்கு வரை. டின்கள் மற்றும் டப்களுக்கு ஒரு அல்லது இரண்டு ஒருங்கிணைந்த அலங்காரங்கள்."}</li><li>{en ? "Delivery is quoted separately within Chennai; orders beyond 20 km include an additional distance-based charge. Appointment pickup is available." : "சென்னை முழுவதும் டெலிவரி தனியாக கணக்கிடப்படும்; 20 கி.மீ.க்கு அப்பாலான ஆர்டர்களுக்கு கூடுதல் தூரக் கட்டணம் சேர்க்கப்படும். நேரம் உறுதி செய்த பிக்கப் கிடைக்கும்."}</li><li>{en ? "Within 72 hours of handover, committed ingredient, printing and production costs are non-refundable. One reschedule may be offered where capacity permits." : "ஹேண்ட்ஓவருக்கு 72 மணி நேரத்திற்குள் உறுதி செய்யப்பட்ட பொருள், அச்சு மற்றும் தயாரிப்பு செலவுகள் திருப்ப முடியாது. திறன் இருந்தால் ஒரு முறை தேதி மாற்றம் வழங்கப்படலாம்."}</li></ul></div>
      </section>

      <section className="eventCta"><p className="eyebrow">READY TO PLAN?</p><h2>{en ? "Review the cart, then send one complete WhatsApp order." : "கார்ட்டை சரிபார்த்து, முழுமையான WhatsApp ஆர்டரை அனுப்புங்கள்."}</h2><p>{en ? "The checkout carries your products, quantities, date, fulfilment preference and subtotal into WhatsApp for final confirmation." : "செக்அவுட் உங்கள் பொருட்கள், அளவுகள், தேதி, பெறும் முறை மற்றும் மொத்தத்தை WhatsApp உறுதிப்படுத்தலுக்கு எடுத்துச் செல்லும்."}</p><div><a className="button buttonLight" href="/preorder">{en ? "Review cart & order" : "கார்ட் & ஆர்டரைப் பார்க்க"}</a></div></section>
    </main>
  );
}
