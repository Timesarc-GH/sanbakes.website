  ...
  return (
    <main>
      <section className="innerHero partyHero">
        ...
        <div className="innerHeroActions"><Link className="button buttonLight" href="/preorder">{en ? "Start a party enquiry" : "பார்ட்டி விசாரணையைத் தொடங்க"}</Link><Link className="button buttonOutlineLight" href="/menu?category=parties">{en ? "View prices & quantities" : "விலை & அளவுகள்"}</Link></div>
      </section>
