...
const operationalGroups = [
  { title:"Brownie Tins", approach:"Keep two distinct formats. The Three-Piece Brownie Tin contains three separate brownie pieces in 3+0, 2+1 or 1+1+1 compositions at ₹310–₹360. The Whole Brownie Tin is one continuous brownie slab with 1/2/3 divided flavour-topping sections at ₹360.", checks:"Validate the net weight and liner separately for each format; confirm topping-section stability, packaging cost, flavour availability, allergens, storage and short-/long-route condition tests." },
