  ...
  return (
    <footer className="siteFooter">
      ...
      <div className="footerGrid">
        <div><strong>{en ? "Explore" : "பார்க்க"}</strong><a href="/menu">{en ? "Brownies" : "பிரௌனிகள்"}</a><a href="/cupcakes">{en ? "Cupcakes" : "கப் கேக்குகள்"}</a><a href="/parties">{en ? "Birthdays & parties" : "பிறந்தநாள் & பார்ட்டி"}</a><a href="/about">{en ? "Our standard" : "எங்கள் தரநிலை"}</a><a href="/faq">{en ? "FAQs" : "கேள்விகள்"}</a></div>
        ...
        <div><strong>{en ? "Gifting & business" : "பரிசுகள் & நிறுவனங்கள்"}</strong><a href="/gifting">{en ? "Personal gifting" : "தனிப்பட்ட பரிசுகள்"}</a><a href="/corporate">{en ? "Corporate orders" : "நிறுவன ஆர்டர்கள்"}</a></div>
