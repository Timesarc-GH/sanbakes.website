  ...
  return (
    <footer className="siteFooter">
      ...
      <div className="footerGrid">
        <div><strong>{en ? "Explore" : "பார்க்க"}</strong><Link href="/menu">{en ? "Menu & pricing" : "மெனு & விலை"}</Link><Link href="/parties">{en ? "Birthdays & parties" : "பிறந்தநாள் & பார்ட்டி"}</Link><Link href="/about">{en ? "Our standard" : "எங்கள் தரநிலை"}</Link><Link href="/faq">{en ? "Frequently asked questions" : "அடிக்கடி கேட்கப்படும் கேள்விகள்"}</Link></div>
        ...
        <div><strong>{en ? "Gifting & business" : "பரிசுகள் & நிறுவனங்கள்"}</strong><Link href="/gifting">{en ? "Personal gifting" : "தனிப்பட்ட பரிசுகள்"}</Link><Link href="/corporate">{en ? "Corporate orders" : "நிறுவன ஆர்டர்கள்"}</Link><span>{en ? "Corporate minimum: 25 boxes or ₹15,000" : "குறைந்தபட்சம்: 25 பெட்டிகள் அல்லது ₹15,000"}</span></div>
