  ...
  return (
    <footer className="siteFooter">
      ...
      <div className="footerGrid">
        <div><strong>{en ? "Explore" : "பார்க்க"}</strong><a href="/menu">{en ? "Menu & pricing" : "மெனு & விலை"}</a><a href="/parties">{en ? "Birthdays & parties" : "பிறந்தநாள் & பார்ட்டி"}</a><a href="/about">{en ? "Our standard" : "எங்கள் தரநிலை"}</a><a href="/faq">{en ? "Frequently asked questions" : "அடிக்கடி கேட்கப்படும் கேள்விகள்"}</a></div>
